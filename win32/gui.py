...
from subprocess import check_call, check_output, CalledProcessError  # To manage the agent on OSX
import logging
import platform
...
from guidata.configtools import get_icon, get_family, MONOSPACE, add_image_path
